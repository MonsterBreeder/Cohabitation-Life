...
用户主动开始使用并完成身份确认后，需要先拥有一个真实的家庭空间，才能继续邀请另一半和共同管理生活事项。当前阶段先跑通最小闭环：没有家庭的用户创建家庭，创建后成为家庭拥有者，并进入真实的单人家庭首页。
...
| 能力 | 未开始使用 | 已开始使用、无家庭 | 家庭拥有者 | 家庭成员（后续） |
| --- | --- | --- | --- | --- |
| 创建家庭 | 不可以 | 可以 | 不可以 | 不可以 |
...
- R1. 已开始使用但尚未加入家庭的用户，应看到创建家庭页，不应进入空白首页。
...
- 新用户可以在一分钟内完成“开始使用 → 确认家庭资料 → 创建家庭 → 进入单人家庭首页”。
...
- 首次开始使用流程需要能够识别“身份已确认、无家庭”并进入创建家庭页。
